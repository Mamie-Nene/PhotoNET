...
<html>
    ...
    -->
      			<div class="logo">
        			<a href="#photonet" class="simple-text logo-normal"> PHOTO NET </a>
      			</div>
        			...
        			<ul class="nav">
				        <c:choose>
							<c:when test="${!empty sessionScope.utilisateur }">
								<c:if test="${sessionScope.utilisateur.userRole=='utilisateurt'}"> 
									<li> <a href="<c:url value='/accueilUserSimple'/>"> <i class="now-ui-icons design_app"></i>  Fil d'actualité </a> </li>
         						</c:if>
         						<c:if test="${sessionScope.utilisateur.userRole=='administrateur'}"> 
									<li> <a href="<c:url value='/accueilAdmin'/>"> <i class="now-ui-icons design_app"></i>  Fil d'actualité </a> </li>
					...
					<div class="container-fluid">
						<div class="navbar-wrapper">
          				...
          				<div class="collapse navbar-collapse justify-content-end" id="navigation">
           					<ul class="navbar-nav">
             					<li class="nav-item"><a class="nav-link" href="#pablo"><i class="now-ui-icons users_single-02"></i>
				                  	<p> <span class="d-lg-none d-md-block">Account</span></p> </a>
				              	</li>
				            </ul>
		         		</div>
		       		</div>
